...
import procyk.industries.shared.constants.FarmableLocationNameConstants;
import procyk.industries.shared.constants.PathConstants;
...
public class TrainSkillGui extends JFrame {
	...
	private TrainSkillGui() {
		...
		for(Field object : procyk.industries.shared.constants.FarmableObjectNameConstants.class.getFields())
		{
			try {
