...
import procyk.industries.constants.ItemNameConstants;
import procyk.industries.constants.NpcNameConstants;
import procyk.industries.constants.ObjectNameConstants;
import procyk.industries.constants.WidgetIdConstants;
import procyk.industries.engines.FightingEngine;
			...
			else if(Backpack.Has(ctx, ObjectNameConstants.RAW_BEEF))
			{
				...
				else
				{
					...
					else
					{
						...
						final GameObject tree = procyk.industries.gameobjects.Select.WithinArea(ctx, cowArea, ObjectNameConstants.TREE).get(0);
