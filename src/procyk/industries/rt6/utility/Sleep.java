package procyk.industries.rt6.utility;
...
public class Sleep {
	...
	public static void WhileNotIdle(ClientContext ctx)
	{
		...
		}while(procyk.industries.rt6.localplayer.Animation.CheckPlayerIdle(ctx) == AnimationConstants.PLAYER_NOT_IDLE);
	}
	public static void WhilePlayer(ClientContext ctx, int animation)
	{
		...
		}while(procyk.industries.rt6.localplayer.Animation.PlayerAnimation(ctx) == animation);
	}
}
