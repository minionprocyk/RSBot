...
import procyk.industries.rt6.engines.FightingEngine;
			...
			else if(Backpack.Has(ctx, ObjectNameConstants.RAW_BEEF))
			{
				...
				else
				{
					...
					else
					{
						...
						final GameObject tree = procyk.industries.rt6.gameobjects.Select.WithinArea(ctx, cowArea, ObjectNameConstants.TREE).get(0);
